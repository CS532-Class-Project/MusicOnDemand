...
/***
* JUnit tests for classes Circle, Circle1, Circle2. Tests are for four functions,construction function, moveby, scale, * and intersects. Dr. Cook has given example on testing moveby, I am going to test scale and
* intersects. For scale function, the tests are chosen for factor to be positive,0, and negative. 
* For intersects function, the tests are chosen so that the two circles are tangent, intersecting, 
* and not intersecting.In this test, circles are generated from class Circle2
***/
...
public class Circle2Test
{
   ...
   private Circle2 circle1, circle2, circle3, circle4;
//
...
{
   System.out.println("\nTest starting...");
   circle1 = new Circle2(1,2,2);
   circle2 = new Circle2(4,2,1);
   circle3 = new Circle2(3,0,1);
   circle4 = new Circle2(4,3,1);
}
